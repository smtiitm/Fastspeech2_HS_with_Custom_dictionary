...
class TTSDurAlignPreprocessor(SharedInit):
    ...
    def preprocess(self, text, language, gender, phone_dictionary, dict_preference):
        # text = text.strip()
        #print(text)
